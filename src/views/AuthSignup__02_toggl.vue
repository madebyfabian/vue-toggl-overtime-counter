<template>
  <div>
    ...
    <form @submit.prevent="handleSubmit" class="auth-form">
      ...
      <input type="password--password-mask" v-model="user.password" placeholder="Toggl-Passwort" required spellcheck="false">
...
<style lang="scss" scoped>
  ...
  input[type=email] ~ input[type=password--password-mask]:not(:placeholder-shown) {
    font-family: 'password-mask';
  }
